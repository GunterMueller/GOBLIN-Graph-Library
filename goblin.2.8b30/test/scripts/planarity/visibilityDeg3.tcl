...
set listOfTestSteps {
    ...
    "Visibility representation" TestVisibilityRepresentation    \
    "Get Width"                 GetWidth                        \
...
proc TestVisibilityRepresentation {testObject testOutput} {
    global goblinMethOrthoRefine
    set goblinMethOrthoRefine 4

    $testObject vertexTruncation DEP_OBJECT
#    ExportAndZip DEP_OBJECT "dump.gob" gob object
    DEP_OBJECT layout visibility -giotto -spacing 10
...
proc TestGifExport {testObject testOutput} {
    ...
    ExportAndZip DEP_OBJECT "$testOutput.truncated.gif" gif bitmap
